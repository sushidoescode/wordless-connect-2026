...
| Gate | Requirement | Status | Evidence |
| --- | --- | --- | --- |
| Core + web + build | `npm run check` passes | PASS | core 411 tests, web unit 109, `tsc` clean, vite build 55 modules / 253 KB (2026-08-30; +18 explicit-input / tree-framing fail-closed regressions this pass) |
